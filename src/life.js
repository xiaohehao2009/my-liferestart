...
class Life {
    ...
    next() {
        ...
        const randomEvent = this.random(event);
        const eventContent = this.doEvent(randomEvent);
    ...
    require(talents, require) {
        return this.#talent.require(talents, require);
    }

    findRequire(talents, require) {
        return this.#talent.findRequire(talents, require);
    }
